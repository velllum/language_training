...
для перевода слов в карточи после клика на кнопку с стрелками, применить функционал радио кнопки 
при кликена котору происходит перезагрузка страницы и происходит превод данных 
для возвращения в обратное состояние, либо использовать функционал
